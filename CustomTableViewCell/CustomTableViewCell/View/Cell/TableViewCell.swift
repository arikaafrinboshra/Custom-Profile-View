...
let ANIM_DURATION: Double = 0.3     //Time for animating
...
class TableViewCell: UITableViewCell {
    ...
    //Variables
    var xPadding: CGFloat = 40.0 //leading & trailing
    var path: UIBezierPath!
    let strokeColor = UIColor(red: 0.3, green: 0.4, blue: 0.2, alpha: 1.0).cgColor
